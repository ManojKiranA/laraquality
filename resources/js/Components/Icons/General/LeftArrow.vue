<template>
    <svg class="inline-block" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="caret-left" role="img" viewBox="0 0 192 512">
